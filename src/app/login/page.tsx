...
type LoginPageProps = { searchParams?: Promise<{ message?: string }> };
    ...
    <main className="min-h-screen bg-white text-slate-950">
      ...
      <section className="mx-auto grid min-h-[calc(100vh-4rem)] max-w-6xl gap-12 px-6 py-14 lg:grid-cols-[1fr_420px] lg:items-center">
        <div className="hidden lg:block">
          ...
          <h1 className="mt-3 max-w-xl text-4xl font-semibold leading-tight tracking-[-0.045em]">One account for websites, scans and retest evidence.</h1>
          ...
          <dl className="mt-8 max-w-xl divide-y divide-slate-200 border-y border-slate-200 text-sm">
            ...
            <div className="grid grid-cols-[160px_1fr] gap-4 py-4"><dt className="font-semibold">Workspace</dt><dd className="text-slate-600">Websites, scans, reports and ownership state</dd></div>
        ...
        <div className="border border-slate-200 p-7 sm:p-8">
          ...
          {message ? <div className="mt-5 border border-amber-200 bg-amber-50 p-3 text-sm font-medium text-amber-950">{message}</div> : null}
          <form action={signInWithGoogle} className="mt-6">
            <button className="flex w-full items-center justify-center gap-3 bg-blue-600 px-5 py-3 text-sm font-semibold text-white hover:bg-blue-700">
