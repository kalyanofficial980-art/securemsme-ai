  ...
  return (
    <main className="min-h-screen bg-white text-slate-950">
      ...
      <section className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="mt-6 flex flex-col justify-between gap-5 border-b border-slate-200 pb-7 lg:flex-row lg:items-end">
          <div>
        ...
        {message ? <div className="mt-6 border border-amber-200 bg-amber-50 p-4 text-sm font-medium text-amber-900">{message}</div> : null}
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-[220px_1fr]">
          ...
          <div className="space-y-5">
            {methods.map((method, index) => (
              <section key={method.key} className="border border-slate-200">
                ...
                <div className="p-5">
                  ...
                  <form action={verifyOwnershipAction} className="mt-5">
                    ...
                    <button className="mt-4 bg-blue-600 px-4 py-2.5 text-sm font-semibold text-white hover:bg-blue-700">{method.button}</button>
                  </form>
                </div>
              </section>
            ))}
        ...
        <div className="mt-8 grid gap-5 border-t border-slate-200 pt-6 lg:grid-cols-[1fr_auto] lg:items-center">
          <div>
          ...
          <form action={rotateVerificationToken}>
            <input type="hidden" name="websiteId" value={website.id} />
            <button className="border border-slate-300 px-4 py-2.5 text-sm font-semibold hover:bg-slate-50">Rotate verification token</button>
          </form>
        </div>
      </section>
    </main>
